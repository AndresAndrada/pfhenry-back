...
async function newUser(name, email) {
    ...
    let informacion = await transporter.sendMail({
      ...
      html: `Hola ${name} . Gracias por elegir a BONITA DEVOTO 👏. <br></br> Nosotors te envitamos a navegar por nuestra pagina y buscar el producto el mejor producto para tu suculentas.
